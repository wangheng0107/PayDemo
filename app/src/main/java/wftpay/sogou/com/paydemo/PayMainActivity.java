...
public class PayMainActivity extends Activity {
        ...
        protected void onPostExecute(Map<String, String> result) {
            ...
            if (result == null) {
                ...
                if (result.get("status").equalsIgnoreCase("0")) // 成功
                {
                    ...
                    msg.setTokenId(result.get("token_id"));//"token_id" -> "27de78edabe48ab96fde2a8d81385a0d5"
    ...
    private String getParams() {
        ...
        params.put("mch_id", "105510071773"); // 威富通商户号
        ...
        String sign = createSign("b4f759250571ef9948c0e3cb80a4669b", params); // 密钥
